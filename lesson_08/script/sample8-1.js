...
var init = function() {
  ...
  // テクスチャー読み込み
  var materials = [
    new THREE.MeshStandardMaterial({map:THREE.ImageUtils.loadTexture("img/dice/dice-2.jpg")}),
    new THREE.MeshStandardMaterial({map:THREE.ImageUtils.loadTexture("img/dice/dice-5.jpg")}),
    new THREE.MeshStandardMaterial({map:THREE.ImageUtils.loadTexture("img/dice/dice-1.jpg")}),
    new THREE.MeshStandardMaterial({map:THREE.ImageUtils.loadTexture("img/dice/dice-6.jpg")}),
